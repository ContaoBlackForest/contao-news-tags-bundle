...
$GLOBALS['TL_LANG']['FMD']['newsTagsShow']['show'] = 'Kategorien';

$GLOBALS['TL_LANG']['FMD']['newsTagsFilter']['filter']      = 'Filter';
$GLOBALS['TL_LANG']['FMD']['newsTagsFilter']['clearFilter'] = 'Filter löschen';

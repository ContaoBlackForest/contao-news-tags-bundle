...
/**
 * This handle if a news archive model delete.
 */
class Delete
{
    /**
    ...
    /**
     * Handle if a news archive model delete.
     *
    ...
    public function handle(DataContainer $container)
    {
        ...
        $queryBuilder
            ...
            ->where($queryBuilder->expr()->eq('r.archive', ':archiveId'))
            ->setParameter(':archiveId', $container->activeRecord->id);

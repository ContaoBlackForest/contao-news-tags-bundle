...
namespace BlackForest\Contao\News\Tags\DependencyInjection;
 ...
 */
class BlackForestContaoNewsTagsExtension extends Extension
{
    /**
     * {@inheritDoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $loader->load('table/news-tags-relation.yml');
